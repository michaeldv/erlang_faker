-define(COMPANY_SUFFIX, 
    ["Inc.", "Corp.", "Corporation", "LLC", "Group", "Associates",
    "International"]).
...
-define(CATCH_POS,
    ...
    "time-frame", "toolset", "utilisation", "website", "workforce"]).
...
-define(BS_PRE,
    ...
    "iterate", "leverage", "matrix", "maximize", "mesh", "monetize", "morph",
    "optimize", "orchestrate", "productize", "recontextualize", "redefine",
    "reintermediate", "reinvent", "repurpose", "revolutionize", "scale",
    "seize", "strategize", "streamline", "syndicate", "synergize", "synthesize",
...
-define(BS_MID,
    ...
    "leading-edge", "magnetic", "mission-critical", "next-generation", "one-to-one",
    "open-source", "out-of-the-box", "plug-and-play", "proactive", "real-time",
    "revolutionary", "rich", "robust", "scalable", "seamless", "sexy", "sticky",
